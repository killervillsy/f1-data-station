  ...
  return (
    <footer className="bg-footer-bg border-t border-border mt-auto">
      <div className="max-w-7xl mx-auto px-2 py-2 sm:px-3">
        <div className="grid grid-cols-1 gap-2 md:grid-cols-4 sm:gap-3">
          <div>
            <Link href="/" className="mb-1.5 flex items-center gap-1.5">
          ...
          <div>
            <h4 className="mb-1.5 text-sm font-medium text-text-primary">导航</h4>
          ...
          <div>
            <h4 className="mb-1.5 text-sm font-medium text-text-primary">数据来源</h4>
            <ul className="space-y-1">
              <li>
                <a
          ...
          <div>
            <h4 className="mb-1.5 text-sm font-medium text-text-primary">社区</h4>
            <ul className="space-y-1">
              <li>
                <a
                ...
                >
                  <svg aria-hidden="true" className="h-5 w-5 shrink-0 rounded-full bg-white p-0.5" viewBox="0 0 24 24" fill="#5865F2">
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-1.5 text-xs text-text-muted hover:text-text-primary"
                >
                  <svg aria-hidden="true" className="h-5 w-5 shrink-0 rounded-full bg-white p-0.5" viewBox="0 0 24 24" fill="#26A5E4">
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-1.5 text-xs text-text-muted hover:text-text-primary"
                >
                  <svg aria-hidden="true" className="h-5 w-5 shrink-0 rounded-full bg-white p-0.5" viewBox="0 0 24 24" fill="#FF4500">
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-1.5 text-xs text-text-muted hover:text-text-primary"
                >
                  <svg aria-hidden="true" className="h-5 w-5 shrink-0 rounded-full bg-white p-0.5" viewBox="0 0 24 24" fill="#E4405F">
