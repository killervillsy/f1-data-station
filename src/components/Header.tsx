...
export default function Header() {
  ...
  return (
    <header ref={headerRef} className="sticky top-0 z-50 bg-header-bg backdrop-blur border-b border-border">
      <div className="relative max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between gap-2 h-16">
          <Link href="/" className="flex min-w-0 items-center gap-2 sm:gap-3" aria-label="返回 F1.Data 首页">
            <Image
          ...
          <div className="flex shrink-0 items-center gap-1 sm:gap-2">
            <div className="relative">
              <button
                ...
                title={`主题：${themeLabel}`}
                className="group flex h-10 cursor-pointer items-center gap-1 rounded-full border border-border bg-surface/90 px-2 text-sm text-text-muted shadow-sm backdrop-blur transition-all hover:border-f1-red hover:bg-hover-surface hover:text-text-primary hover:shadow-md focus:border-f1-red focus:outline-none sm:gap-2 sm:px-3"
              >
                <span className="hidden h-6 w-6 items-center justify-center rounded-full bg-surface-muted text-f1-red transition-colors group-hover:bg-selected-surface sm:flex">
                  <svg
                    aria-hidden="true"
                ...
                <span className="hidden text-xs font-medium sm:inline">主题</span>
                <span className="hidden h-4 w-px bg-border sm:block" />
                <span className="min-w-8 text-left font-semibold text-text-primary sm:min-w-16">
                  {themeLabel}
                </span>
                <svg
                  aria-hidden="true"
                  className={`h-3.5 w-3.5 text-text-subtle transition-all group-hover:text-f1-red ${
              ...
              <div
                ...
                className={`absolute right-0 z-50 mt-3 w-44 origin-top-right overflow-hidden rounded-2xl border border-border bg-surface/95 p-2 shadow-xl backdrop-blur transition-all duration-200 ease-out ${
                  isThemeMenuOpen
